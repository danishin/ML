...
import dase.data.{Item, PreparedData, ViewEvent}
...
// top co-occurrence
case class CooccurrenceAlgorithmParams(n: Int) extends Params

case class CooccurrenceModel(topCooccurrences: Map[Int, Array[(Int, Int)]], itemStringIntMap: BiMap[String, Int], items: Map[Int, Item]) {
  @transient lazy val itemIntStringMap = itemStringIntMap.inverse

  override def toString: String =
    topCooccurrences.mapValues(_.mkString(",")).toString()
}

class CooccurrenceAlgorithm(params: CooccurrenceAlgorithmParams) extends P2LAlgorithm[PreparedData, CooccurrenceModel, Query, PredictedResult] {
